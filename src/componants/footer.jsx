    ...
    return (
        <>
            <footer id='footer' className={ style["footer"]}>
                <div className={ style["contact-links"]}>
                    <a
                    href="https://www.linkedin.com/in/yossef-ayman-89a98033a"
                    ...
                    <a
                    href="https://www.facebook.com/share/1EXmNaQDUQ/"
                    className={style["social-link"]}>
                        <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="40px"
                ...
                <div className={style["footer-logo"]}>
                    <img
                        src="https://cdn.aseeralkotb.com/images/logo.svg"
                        alt=""
                        />
                </div>
            </footer>
